...
const HERO_STATS = [
  ...
  { label: 'Actualizado',  value: 'Hoy', trend: '14:02' },
];
...
// ---------- HOME ----------
const Home = ({ onOpen, onCategory }) => {
  const featured = lookupArticle('a-blocks');
  const trending = ['a-auth', 'a-shortcuts', 'a-webhooks', 'a-publish'].map(lookupArticle);
    ...
    <div className="home-wrap">
      ...
      <section className="home-hero">
        ...
        <div className="hh-inner">
          ...
          <p className="hh-sub">
            151 artículos escritos en Markdown, organizados en 6 categorías y 28 carpetas.
          ...
          <div className="hh-cta">
            ...
            <button className="btn-ghost" style={{padding: '8px 14px', border: '1px solid var(--border)'}}>
          ...
          <div className="featured-card" onClick={() => onOpen(featured)}>
            <div className="featured-img">
              <div className="fi-overlay">
                <div className="fi-cat">{featured.category} · {featured.folder}</div>
                <div className="fi-title">{featured.title}</div>
                <div className="fi-meta">
                  <span>Lucía Méndez · 6 min de lectura · Hoy</span>
                </div>
              </div>
            </div>
          </div>
            ...
            {trending.map((a, i) => (
              <li key={a.id} className="trend-row" onClick={() => onOpen(a)}>
                ...
                <div className="trend-main">
                  ...
                  <div className="trend-path">{a.category} · {a.folder}</div>
                </div>
      ...
      <section className="home-split">
        <div className="home-section">
          ...
          <div className="quick-grid">
            ...
            <button className="quick-card">
              ...
              <div><strong>Importar .md</strong><span>Sube una carpeta completa</span></div>
            </button>
            <button className="quick-card">
        ...
        <div className="home-section">
          ...
          <div className="home-tags">
            {TAGS.map(t => {
              const scale = 0.8 + (t.count / 42) * 0.7;
              return (
